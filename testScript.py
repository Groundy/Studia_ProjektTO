...
def doSingleCalc(posY, posX, amp):
    ...
    fileName = pathToResultFolder + str(-amp) + "ORG.png"
    cv2.imwrite(fileName ,orgImg)
...
for amp in amplificationLevels:
    psnr, mad, mse = doSingleCalc(222, 222, amp)
    print(str(amp))
